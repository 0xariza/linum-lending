...
/**
 * @title IYieldToken
 * @dev Interface for the YieldToken rebasing ERC20 token
 * @notice This interface defines all external functions and events for the YieldToken contract
 */
interface IYieldToken {
    ...
    /**
     * @dev Emitted when donated assets are handled
     * @param donatedAmount Amount of assets donated
     */
    event DonationHandled(uint256 donatedAmount);

    /**
     * @dev Emitted when assets are synced
     * @param newTotalAssets New total assets value
     * @param untrackedAssets Amount of previously untracked assets
     */
    ...
    /**
     * @dev Handle donated assets by updating totalMintedAssets (lending protocol only)
     * @param donatedAmount Amount of assets donated
     */
    function handleDonation(uint256 donatedAmount) external;

    /**
     * @dev Sync tracked assets with actual contract balance (lending protocol only)
     * @param newTotalAssets New total assets value
     */
    function syncAssets(uint256 newTotalAssets) external;
